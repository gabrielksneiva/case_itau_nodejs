...
func NewSqliteCustomerRepo(db *gorm.DB) repository.CustomerRepo {
...
func (r *sqliteRepo) GetByID(id uint) (repository.Clientes, error) {
...
func (r *sqliteRepo) Delete(id uint) error {
...
func (r *sqliteRepo) ChangeBalance(id uint, delta decimal.Decimal) (repository.Clientes, error) {
	var c repository.Clientes
	tx := r.db.Begin()
